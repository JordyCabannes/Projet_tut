...
int launch() {
    ...
    tb->create_result("/vagrant/ubimob/analysis/experiments/dec2015/Results/exp004.csv");
...
//###############################################################################################################
        ...
        if (m->shared_path_len() > 0){
            ...
            tb->save_result("/vagrant/ubimob/analysis/experiments/dec2015/Results/exp004.csv", output, g);
