#include "Ridesharing/privacy2.h"
...
int launch() {
    ...
    tb->create_result("/vagrant/ubimob/analysis/experiments/dec2015/Results/exp005.csv");
...
//###############################################################################################################
        ...
        if (m->shared_path_len() > 0){
            ...
            output.rider_path_ordering_time=0.0;
            ...
            output.privacy_pickup = m->getThePath_great().start;
            output.privacy_dropoff = m->getThePath_great().end;
            ...
            tb->save_result("/vagrant/ubimob/analysis/experiments/dec2015/Results/exp005.csv", output, g);
